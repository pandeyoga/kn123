...
- **Waktu:** 2026-09-05 13:12:09
- **Mode:** `quick`  ·  **Durasi total:** 21s  ·  **Pekerja statik:** 2
...
| guard:detail_modal (INV-UI-08, panel rincian wajib pop-up) | PASS (0s) |
...
| guard:escape_layers SELF-TEST (bukti-merah + anti tuduh palsu, 13 kasus) | FAIL (1s) |
...
| guard:codebase_map (INV-DOC-01, CODEBASE_MAP.md selaras kode) | PASS (0s) |
