...
| **Sopir (peran ke-8 · FB-02)** | **`driver@kainnusantara.id`** | **Joko Susilo** — hanya modul **Logistik** (`nav-logistics`) + Profil Saya. Boleh unggah foto muat/POD, catat posisi, ubah tahapan; TIDAK boleh membuat pengiriman (itu gudang/admin/manajer). |
